...
<head>
    ...
    <meta name="description"
        content="Discover exquisite Premium 3 BHK luxury floors in Gurgaon. Enjoy premium amenities, spacious layouts, and modern designs. Find your dream home today!.">
    <meta name="keywords"
        content="3 bhk luxury apartments for sale, 3 bhk floors, Floors, 3 bhk in Gurgaon, 3 bhk luxury floors">
    <!--=====FAB ICON=======-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-elements">
                            <div class="site-log">
                                <a href="{{ url('/') }}"><img
                                        src="{{ asset('public') }}/front-assets/img/logo/nld-logo55.png" alt="nld logo"
                                    ...
                                    <li><a href="#">Project &nbsp;<i class="fa-solid fa-angle-down"></i></a>
                                        <ul class="dropdown-padding">
                                            @foreach ($project as $p)
                                                <li><a
                                                        href="{{ url('project/' . $p->id) }}">{{ $p->project_name }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </li>
                            ...
                            <button type="button" class="btn-area4" data-toggle="modal"
